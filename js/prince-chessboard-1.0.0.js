...
;(function () {
  ...
  var START_FEN = 'rnbcqkcbnr/pppppppppp/10/10/10/10/PPPPPPPPPP/RNBCQKCBNR'
  ...
  function validPieceCode (code) {
    return isString(code) && code.search(/^[bw][KQCRNBP]$/) !== -1
  }
  ...
  function validFen (fen) {
    ...
    for (var i = 0; i < 8; i++) {
      if (chunks[i].length !== 10||
          chunks[i].search(/[^kqcrnbpKQCRNBP1]/) !== -1) {
        return false
      }
    }
  ...
  if (RUN_ASSERTS) {
    ...
    console.assert(validFen('10/10/10/10/10/10/10/10'))
    console.assert(validFen('r1bqkbnrcc/pppp1pppcc/2n5cc/1B2p3cc/4P3cc/5N2cc/PPPP1PPPcc/RNBQK2Rcc'))
    console.assert(validFen('3r3rcc/1p4ppcc/2nb1k2cc/pP3p2cc/8cc/PB2PN2cc/p4PPPcc/R4RK1 b - - 0 1cc'))
    console.assert(!validFen('3r3zcc/1p4ppcc/2nb1k2cc/pP3p2cc/8cc/PB2PN2cc/p4PPPcc/R4RK1 b - - 0 1cc'))
    console.assert(!validFen('anbqkbnrcc/8cc/8cc/8cc/8cc/8cc/PPPPPPPPcc/8cc'))
    console.assert(!validFen('rnbqkbnrcc/ppppppppcc/8cc/8cc/8cc/8cc/PPPPPPPPcc/cc'))
    console.assert(!validFen('rnbqkbnrcc/ppppppppcc/8cc/8cc/8cc/8cc/PPPPPPPPcc/RNBQKBNcc'))
    console.assert(!validFen('888888cc/ppppppppcc/8cc/8cc/8cc/8cc/PPPPPPPPcc/RNBQKBNRcc'))
    console.assert(!validFen('888888cc/ppppppppcc/74cc/8cc/8cc/8cc/PPPPPPPPcc/RNBQKBNRcc'))
  ...
  if (RUN_ASSERTS) {
    ...
    console.assert(objToFen({}) === '10/10/10/10/10/10/10/10')
    console.assert(objToFen({a2: 'wP', 'b2': 'bP'}) === '10/10/10/10/10/10/Pp8/10')
  }
  ...
  function constructor (containerElOrString, config) {
    ...
    function buildSparePiecesHTML (color) {
      var pieces = ['wK', 'wQ', 'wC', 'wR', 'wB', 'wN', 'wP']
      if (color === 'black') {
        pieces = ['bK', 'bQ', 'bC', 'bR', 'bB', 'bN', 'bP']
      }
    ...
    widget.resize = function () {
      ...
      // set board width
      $board.css('width', squareSize * 10 + 'px')
